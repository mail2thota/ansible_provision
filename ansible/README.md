...
default:
	...
	java_vendor: it is set either 'oracle' or 'openjdk'. when it is configured as 'oracle' will install oracle java8u112 and configured 'openjdk' will install  java-1.8.0-openjdk     
