    ...
    def __init__(self):
	  ...
	  Required('default',msg='default doesn\'t exists'): Any(dict),
       ...
       self.es_config = Schema({
           Required('network.host',msg='es_master[es_config][network.host] doesn\'t exists'):   Match('^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$',msg='networki.host does''t match with expected ip4 version but Configured Value'),
